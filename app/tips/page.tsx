        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-14 md:h-16">
            ...
            <div className="hidden lg:flex items-center gap-6 text-sm font-semibold text-gray-500">
              ...
              <Link href="/tips" className="text-indigo-600 flex items-center gap-1.5">
                ATS Tips
              </Link>
        ...
        {isMobileMenuOpen && (
          <div className="lg:hidden bg-white border-t border-gray-100 py-4 px-4 shadow-xl">
            <div className="flex flex-col gap-2">
              ...
              <Link href="/templates" className="flex items-center gap-3 p-3 rounded-xl font-bold text-sm text-gray-600 hover:bg-gray-50 transition-all">
                <Layout size={18} /> Templates
              </Link>
              <Link href="/tips" className="flex items-center gap-3 p-3 rounded-xl font-bold text-sm bg-indigo-50 text-indigo-600">
