...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  // Dynamic resume example pages (20 paths)
  const resumePages: MetadataRoute.Sitemap = Object.values(RESUME_EXAMPLES).map((item) => ({
  ...
  // Dynamic career resources & ATS educational pages (30 paths)
  ...
  return [...staticPages, ...resumePages, ...tipPages];
}
