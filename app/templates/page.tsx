...
export default function TemplatesPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FAFAFC] text-[#0F172A] font-sans selection:bg-[#5B4DFF]/10 selection:text-[#5B4DFF] relative overflow-hidden pb-20">
      
      {/* Soft background blur gradients matching homepage styling */}
      <div className="absolute top-[8%] left-[-15%] w-[450px] h-[450px] bg-[#5B4DFF]/5 rounded-full blur-[130px] pointer-events-none"></div>
      <div className="absolute top-[35%] right-[-15%] w-[550px] h-[550px] bg-[#A855F7]/4 rounded-full blur-[140px] pointer-events-none"></div>
      <div className="absolute bottom-[20%] left-[-10%] w-[480px] h-[480px] bg-[#FF5EA8]/3 rounded-full blur-[120px] pointer-events-none"></div>
      ...
      <div className="border-b border-[#ECECF5] py-16 sm:py-24 relative overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 space-y-8">
          ...
          <div className="text-center space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 bg-[#5B4DFF]/10 text-[#5B4DFF] text-xs font-extrabold rounded-full tracking-wider uppercase">
            ...
            <h1 className="text-4xl md:text-7xl font-extrabold text-[#0F172A] tracking-tight leading-none font-sans">
              Choose Your <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#5B4DFF] via-[#A855F7] to-[#FF5EA8]">Resume Template</span>
            </h1>
            ...
            <div className="text-center">
              <Link 
                href="/ats-checker" 
                className="inline-flex items-center gap-1.5 text-xs sm:text-sm font-bold text-[#5B4DFF] hover:text-[#A855F7] bg-[#5B4DFF]/5 px-4 py-1.5 rounded-full transition-colors group border border-[#5B4DFF]/15"
              >
          ...
          <div className="max-w-2xl mx-auto space-y-4">
            <div className="relative group">
              <div className="absolute inset-0 bg-[#5B4DFF]/5 rounded-2xl blur group-hover:bg-[#5B4DFF]/10 transition-colors duration-300 pointer-events-none"></div>
              <div className="relative bg-white border border-[#ECECF5] group-hover:border-[#5B4DFF]/30 rounded-2xl flex items-center px-4 py-1 gap-3 shadow-lg hover:shadow-xl transition-all">
                <Search size={22} className="text-[#64748B] group-focus-within:text-[#5B4DFF] transition-colors" />
                <input 
                  type="text" 
                  value={searchQuery}
                ...
                <button
                  ...
                  className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-xs font-bold uppercase transition-all cursor-pointer ${
                    showFilters || selectedExperience !== 'All' || selectedStyle !== 'All' || selectedIndustry !== 'All'
                      ? 'bg-[#5B4DFF]/10 text-[#5B4DFF] hover:bg-[#5B4DFF]/15'
                      : 'bg-[#FAFAFC] text-[#64748B] hover:bg-[#5B4DFF]/5 hover:text-[#5B4DFF]'
                  }`}
                >
                  <SlidersHorizontal size={14} />
                  <span className="hidden sm:inline">Filters</span>
                  {(selectedExperience !== 'All' || selectedStyle !== 'All' || selectedIndustry !== 'All') && (
                    <span className="w-2 h-2 rounded-full bg-[#5B4DFF]"></span>
                  )}
                </button>
              </div>
            </div>
                ...
                >
                  ...
                  <div className="space-y-2">
                    ...
                    <select 
                      ...
                      className="w-full p-3 bg-[#FAFAFC] hover:bg-[#FAFAFC]/60 border border-[#ECECF5] rounded-xl text-xs font-extrabold text-[#0F172A] focus:outline-none focus:border-[#5B4DFF] cursor-pointer"
                    >
                  ...
                  <div className="md:col-span-3 flex justify-between items-center pt-4 border-t border-[#ECECF5] text-xs font-bold">
                    ...
                    <button 
                      ...
                      className="text-[#5B4DFF] hover:text-[#5B4DFF]/80 transition-colors uppercase"
                    >
                      Clear All Filters
                    </button>
                  </div>
                ...
                <button
                  ...
                  className={`px-5 py-2.5 rounded-full text-xs font-bold uppercase transition-all duration-200 flex-shrink-0 border cursor-pointer ${
                    isActive 
                      ...
                      : 'bg-white border-[#ECECF5] text-[#64748B] hover:bg-[#5B4DFF]/10 hover:text-[#5B4DFF] hover:border-[#5B4DFF]/25'
                  }`}
                >
                  {category}
                </button>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-8 space-y-12">
            ...
            {selectedProfession && (
              <div className="bg-gradient-to-r from-[#5B4DFF]/10 to-[#A855F7]/10 border border-[#5B4DFF]/20 rounded-[24px] p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="flex items-center gap-3">
                  ...
                  <div className="text-left">
                    ...
                    <p className="text-sm font-extrabold text-[#0F172A]">
                      Showing templates optimized for <span className="text-[#5B4DFF] font-black">{PROFESSION_MAP[selectedProfession]?.label || selectedProfession}</span>
                    </p>
                  </div>
                </div>
                <button
            ...
            {selectedCategory === 'All' && !searchQuery && !selectedProfession && (
              <section 
                style={{
                  background: 'linear-gradient(135deg, rgba(91,77,255,0.08), rgba(168,85,247,0.04))'
                }}
                className="rounded-[40px] p-6 sm:p-10 border border-[#5B4DFF]/10 space-y-8 shadow-sm"
              >
                <div className="flex items-center justify-between">
                  <div className="space-y-1">
                    <h2 className="text-2xl font-black tracking-tight text-[#0F172A] flex items-center gap-2 font-sans">
                      <Star size={20} className="text-[#5B4DFF] fill-[#5B4DFF]" />
                  ...
                  <span className="text-[10px] bg-gradient-to-r from-[#5B4DFF] via-[#A855F7] to-[#FF5EA8] text-white px-3 py-1 rounded-full font-extrabold uppercase shadow-md">Most Loved</span>
                </div>
                    ...
                    return (
                      <div 
                        ...
                        className={`relative bg-white rounded-[28px] p-4 sm:p-5 transition-all duration-300 flex flex-col justify-between h-full group ${
                          isSelected 
                            ? 'shadow-[0_0_25px_rgba(91,77,255,0.25)]' 
                            : 'shadow-sm hover:shadow-[0_15px_30px_rgba(91,77,255,0.12)] hover:-translate-y-1.5'
                        }`}
                        style={{
                          border: isSelected ? '2px solid transparent' : '1px solid #ECECF5',
                          backgroundImage: isSelected ? 'linear-gradient(white, white), linear-gradient(90deg, #5B4DFF, #A855F7, #FF5EA8)' : 'none',
                          backgroundOrigin: 'border-box',
                          backgroundClip: 'padding-box, border-box',
                        }}
                      >
                        {isSelected && (
                          <div className="absolute top-4 right-4 z-20 bg-gradient-to-r from-[#5B4DFF] via-[#A855F7] to-[#FF5EA8] text-white p-1.5 rounded-full shadow-md animate-pulse">
                          ...
                          <div className="aspect-[8.5/11] relative overflow-hidden rounded-[24px] bg-[#F8FAFC] border border-[#ECECF5]">
                            ...
                            <div className="absolute inset-0 bg-slate-950/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col gap-2 items-center justify-center p-3">
                              <button
                                ...
                                className="w-full max-w-[130px] py-2 bg-white text-[#5B4DFF] font-extrabold text-[10px] sm:text-xs rounded-xl shadow-md uppercase tracking-wider flex items-center justify-center gap-1.5 hover:bg-slate-50 transition-colors cursor-pointer"
                              >
                                <Maximize2 size={12} /> Live Preview
                              </button>
                              <Link 
                                href={`/templates/${getTemplateSlug(template.id)}`}
                                className="w-full max-w-[130px] py-1.5 sm:py-2 bg-[#5B4DFF] text-white font-extrabold text-[10px] sm:text-xs rounded-xl uppercase tracking-wider border border-white/20 hover:opacity-90 transition-opacity text-center"
                              >
                                SEO Detail
                              </Link>
                            </div>
                        ...
                        <button
                          ...
                          className="mt-4 w-full py-2 sm:py-3 text-white font-extrabold text-[10px] sm:text-xs rounded-[16px] shadow-sm shadow-[#5B4DFF]/10 hover:shadow-[#5B4DFF]/25 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 uppercase tracking-wider cursor-pointer"
                        >
                        ...
                        >
                          ...
                          <div>
                            ...
                            <div className="mb-3 flex items-center justify-between flex-wrap gap-1.5">
                              <span className="text-[9px] sm:text-[11px] font-extrabold text-[#5B4DFF] bg-[#5B4DFF]/10 px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-full uppercase">
                                {template.category}
                              </span>
                              {template.ats && (
                            ...
                            <div className="aspect-[8.5/11] relative overflow-hidden rounded-[24px] bg-[#F8FAFC] border border-[#ECECF5] mb-4">
                              ...
                              <div className="absolute inset-0 bg-slate-950/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col gap-2 items-center justify-center p-2 sm:p-4">
                                <button
                                  onClick={() => handleOpenPreview(template)}
                                  className="w-full max-w-[140px] py-1.5 sm:py-2.5 bg-white text-[#5B4DFF] font-extrabold text-[10px] sm:text-xs rounded-xl shadow-lg flex items-center justify-center gap-1.5 hover:bg-slate-50 transition-colors uppercase tracking-wider cursor-pointer"
                                >
                                ...
                                <Link 
                                  href={`/templates/${getTemplateSlug(template.id)}`}
                                  className="w-full max-w-[140px] py-1.5 sm:py-2.5 bg-[#5B4DFF] text-white font-extrabold text-[10px] sm:text-xs rounded-xl shadow-lg flex items-center justify-center gap-1.5 hover:opacity-90 transition-opacity uppercase tracking-wider border border-white/20 text-center"
                                >
                            ...
                            <div className="space-y-1.5 px-0.5">
                              <div className="flex items-center justify-between flex-wrap gap-1">
                                <h3 className="font-extrabold text-sm sm:text-lg text-[#0F172A] tracking-tight group-hover:text-[#5B4DFF] transition-colors truncate">
                                  {template.name}
                                </h3>
                              </div>
                          ...
                          <div className="mt-4 pt-3 border-t border-[#ECECF5]">
                            <button
                              ...
                              className="w-full py-2 sm:py-3 text-white font-extrabold text-[10px] sm:text-xs rounded-[16px] shadow-sm shadow-[#5B4DFF]/10 hover:shadow-[#5B4DFF]/25 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-1 sm:gap-1.5 uppercase tracking-wider cursor-pointer"
                            >
                              <Check size={12} strokeWidth={3} />
                              Use Template
                            </button>
            ...
            <section className="bg-white border border-[#ECECF5] rounded-[32px] p-8 sm:p-10 space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 my-4 text-xs font-semibold">
                ...
                <div className="space-y-3 bg-[#5B4DFF]/5 p-6 rounded-3xl border border-[#5B4DFF]/15">
                  <h3 className="font-extrabold text-sm text-[#0F172A] flex items-center gap-1.5"><TrendingUp size={16} className="text-[#5B4DFF]" /> Recommended Matching Types</h3>
        ...
        <section className="mt-24 border-t border-[#ECECF5] pt-16 space-y-8">
          <div className="text-center md:text-left space-y-2">
            <h2 className="text-2xl sm:text-3xl font-extrabold text-[#0F172A] tracking-tight leading-none flex items-center justify-center md:justify-start gap-2 font-sans">
              <Briefcase className="text-[#5B4DFF]" size={24} />
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {relatedExamples.map((ex) => (
              <Link 
                ...
                className="bg-white border border-[#ECECF5] rounded-[24px] p-6 shadow-sm hover:shadow-lg hover:border-[#5B4DFF]/30 hover:-translate-y-1 transition-all duration-300 flex flex-col justify-between group"
              >
                <div className="space-y-4">
                  <div className="bg-[#5B4DFF]/10 text-[#5B4DFF] w-10 h-10 rounded-xl flex items-center justify-center font-bold">
                    <Briefcase size={18} />
                  </div>
                  <div>
                    <h3 className="font-extrabold text-[#0F172A] group-hover:text-[#5B4DFF] transition-colors leading-tight">
                      {ex.role}
                    </h3>
                    <p className="text-[9px] text-[#5B4DFF] font-extrabold uppercase mt-1">Starting Salary: {ex.marketSalary.split(" - ")[0]}</p>
                  </div>
                  <p className="text-[#64748B] text-xs line-clamp-3 leading-relaxed">
                    {ex.objective}
                  </p>
                </div>
                <div className="mt-4 pt-4 border-t border-[#ECECF5] flex items-center justify-between text-xs font-bold text-[#5B4DFF] uppercase tracking-wider font-semibold">
              ...
              <div className="p-6 border-b border-[#ECECF5] flex items-center justify-between gap-4 flex-shrink-0 bg-white/50 backdrop-blur">
                <div className="space-y-1">
                  <div className="flex items-center gap-2 flex-wrap">
                    ...
                    <span className="text-[10px] bg-[#5B4DFF] text-white px-2.5 py-0.5 rounded font-bold uppercase tracking-wider">{previewTemplate.category}</span>
              ...
              <div className="flex-1 overflow-y-auto p-6 md:p-8 grid grid-cols-1 md:grid-cols-12 gap-8 items-start bg-[#FAFAFC]">
                ...
                <div className="md:col-span-7 flex flex-col items-center">
                  ...
                  >
                    ...
                    <button
                      ...
                      className="absolute top-4 right-4 z-10 p-2.5 bg-white/90 backdrop-blur-sm border border-[#ECECF5] hover:bg-white text-[#5B4DFF] rounded-xl shadow-md transition-all flex items-center gap-1.5 text-xs font-bold uppercase cursor-pointer pointer-events-auto"
                    >
                ...
                <div className="md:col-span-5 space-y-6 text-[#0F172A]">
                  <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3 bg-[#5B4DFF]/5 p-4 rounded-2xl border border-[#5B4DFF]/10">
                      ...
                      <div className="flex items-start gap-3 bg-white p-4 rounded-2xl border border-[#ECECF5]">
                        <CheckCircle2 size={18} className="text-[#5B4DFF] mt-0.5 flex-shrink-0" />
                        <div>
                  ...
                  <div className="pt-4 border-t border-[#ECECF5] text-center space-y-4">
                    <button
                      ...
                      className="w-full py-4 text-white font-extrabold rounded-[16px] shadow-xl shadow-[#5B4DFF]/15 hover:shadow-[#5B4DFF]/30 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200 flex items-center justify-center gap-2 group cursor-pointer uppercase text-sm tracking-wider"
                    >
            ...
            <div className="p-4 sm:p-6 border-b border-slate-800 bg-slate-900/50 backdrop-blur flex items-center justify-between">
              <div>
                <h3 className="font-extrabold text-white text-lg flex items-center gap-2">
                  {previewTemplate.name} <span className="text-[10px] bg-[#5B4DFF] text-white px-2.5 py-0.5 rounded font-bold uppercase tracking-wider">{previewTemplate.category}</span>
                </h3>
