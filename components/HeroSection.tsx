  ...
  return (
    <div className="bg-white border-b border-gray-100 py-20 md:py-32 overflow-hidden relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3 py-1 bg-indigo-50 text-indigo-700 rounded-full text-xs font-bold uppercase tracking-widest mb-8">
          ...
          <div className="flex flex-col md:flex-row justify-center gap-6 mb-16">
            <button 
              ...
              className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-indigo-600 text-white rounded-2xl font-bold text-xl hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 hover:-translate-y-1"
            >
              Build Resume Now 🚀
            </button>
            <div className="flex flex-col items-center gap-4">
              <span className="text-sm font-bold text-indigo-600 uppercase tracking-widest">Check Your Resume ATS Score ⚡</span>
              <button 
                onClick={() => router.push('/ats-score')}
                className="inline-flex items-center justify-center gap-2 px-10 py-5 bg-white border-2 border-indigo-600 text-indigo-600 rounded-2xl font-bold text-xl hover:bg-indigo-50 transition-all hover:-translate-y-1"
              >
                Upload Resume 📄
              </button>
            </div>
