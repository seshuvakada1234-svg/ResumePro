...
export const ClassicTemplate: React.FC<{ data: ResumeData }> = ({ data }) => {
  ...
  return (
    <div className="a4-page font-serif text-gray-800 p-[20mm] overflow-hidden">
      <header className="border-b-2 border-gray-800 pb-6 mb-8 text-center">
        ...
        <div className="flex justify-center gap-4 mt-3">
          {personalInfo.linkedin && (
            <a href={personalInfo.linkedin} className="flex items-center gap-1 text-xs text-gray-500 hover:text-indigo-600">
              <Linkedin size={12} /> LinkedIn
            </a>
          )}
          {personalInfo.github && (
            <a href={personalInfo.github} className="flex items-center gap-1 text-xs text-gray-500 hover:text-indigo-600">
