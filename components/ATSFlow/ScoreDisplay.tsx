  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12 space-y-12">
      ...
      <motion.div
        ...
        className="bg-white rounded-[3rem] p-12 shadow-2xl shadow-indigo-100 border border-gray-100 relative overflow-hidden"
      >
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 relative z-10">
          ...
          <div className="flex-1 space-y-6 text-center md:text-left">
            <div className="space-y-2">
              <h2 className="text-4xl font-extrabold text-gray-900 tracking-tight">ATS Analysis Complete ⚡</h2>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-4">
              ...
              <button
                onClick={onReupload}
                className="px-4 py-2 bg-gray-100 text-gray-600 rounded-full text-sm font-bold flex items-center gap-2 hover:bg-gray-200 transition-colors"
              >
                <RefreshCw size={16} />
                Re-upload Resume
              </button>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-8">
          <div className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-indigo-50 border border-gray-100 space-y-8">
            <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight">Score Breakdown</h3>
              ...
              {breakdown.map((item, i) => (
                <div key={i} className="space-y-3">
                  <div className="flex justify-between items-end">
                    ...
                    <span className="text-xs font-bold text-gray-400">Weight: {item.weight}%</span>
                  </div>
        ...
        <div className="lg:col-span-5 space-y-8">
          <div className="bg-white rounded-[2.5rem] p-10 shadow-xl shadow-indigo-50 border border-gray-100 space-y-8">
            <h3 className="text-2xl font-extrabold text-gray-900 tracking-tight">Improvement Tips</h3>
            <div className="space-y-4">
              {tips.map((tip, i) => (
                <motion.div
                  ...
                  className="flex gap-4 p-5 bg-gray-50 rounded-2xl border border-gray-100 group hover:bg-indigo-50 hover:border-indigo-100 transition-all"
                >
                  <div className="bg-white w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0 shadow-sm group-hover:bg-indigo-600 group-hover:text-white transition-colors">
                    <Zap size={16} className="text-amber-500 group-hover:text-white" fill="currentColor" />
                  </div>
